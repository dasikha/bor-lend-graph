...
con.connect(function(err) {
  ...
  let sql =
    ...
    + "ALTER TABLE contacts ADD CONSTRAINT contacts_fk0 FOREIGN KEY (user_id) REFERENCES users (id); ALTER TABLE loan ADD CONSTRAINT loan_fk0 FOREIGN KEY (borrower_id) REFERENCES users (id); ALTER TABLE loan ADD CONSTRAINT loan_fk1 FOREIGN KEY (lender_id) REFERENCES contacts (id); ALTER TABLE loan ADD CONSTRAINT loan_fk2 FOREIGN KEY (category_id) REFERENCES category (id); ALTER TABLE payment ADD CONSTRAINT payment_fk0 FOREIGN KEY (loan_id) REFERENCES loan (id); ";
  ...
  con.query(sql + sqlInsert, function(err, result) {
    if (err) throw err;
    console.log("Tables creation with dummy data for 'borrowlend' db were successful!");

...
con.connect(function(err) {
  ...
  let sql =
    ...
    + "CREATE TABLE users (id int NOT NULL AUTO_INCREMENT PRIMARY KEY, name varchar(255) NOT NULL, email varchar(255) NOT NULL, password varchar(50) NOT NULL, threshold_limit decimal(5,2), threshold_period varchar(10)); "
    ...
    + "CREATE TABLE loan (id int NOT NULL AUTO_INCREMENT PRIMARY KEY, user_id int NOT NULL, contact_id int NOT NULL, date DATETIME NOT NULL, initial_amount decimal(5,2) NOT NULL, category_id int NOT NULL, remarks TEXT, status varchar(8) NOT NULL DEFAULT 'active', type varchar(8) NOT NULL DEFAULT 'borrow', FOREIGN KEY (user_id) REFERENCES users (id), FOREIGN KEY (contact_id) REFERENCES contacts (id), FOREIGN KEY (category_id) REFERENCES category (id)); "
    + "CREATE TABLE payment (id int NOT NULL AUTO_INCREMENT PRIMARY KEY, loan_id int NOT NULL, amount_paid decimal(5,2) NOT NULL, date DATETIME NOT NULL, FOREIGN KEY (loan_id) REFERENCES loan (id));"
